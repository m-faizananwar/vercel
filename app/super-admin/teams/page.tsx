                ...
                >
                  <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-start">
                    <div className="flex-1 space-y-3">
                      ...
                      <div>
                        <h3 className="mb-1 text-lg font-semibold text-foreground">{team.team_name}</h3>
                        {team.description && (
                      ...
                      {/* Join Code and Statistics */}
                      <div className="flex flex-wrap items-center gap-4 text-sm">
                        <code className="rounded bg-muted/50 px-2 py-1 font-mono text-xs">
                          {team.join_code}
                        </code>
                        <span className="text-muted-foreground">{team.member_count} members</span>
                        <span className="text-muted-foreground">{team.admin_count} admins</span>
                        <span className="text-muted-foreground">{team.chat_count} chats</span>
                      </div>
                    </div>
